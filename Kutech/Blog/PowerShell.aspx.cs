...
namespace Kutech.Blog
{
    public partial class PowerShell : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            myDataSet = myDAL.getBlogMaxPage("PowerShell");
            ...
            createBlogDivs(myDAL.getBlogPageBlogs(pageNo, "PowerShell"));

            recentLoad();

            myDataSet = myDAL.getBlogCategoryList("PowerShell");
        ...
        {
            myDataSet = myDAL.getBlogRecentList("PowerShell");
            int anchorStart = 1;
