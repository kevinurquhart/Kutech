<%@ Page Title="" Language="C#" MasterPageFile="~/blog.Master" AutoEventWireup="true" CodeBehind="search.aspx.cs" Inherits="Kutech.Blog.search" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div id="blogMainDivWrapper">
        <article class="blogMainDiv">
            <div style="background-color:#f5f5f5; text-align:center;">
                <h5>Search Results...</h5><br /></div>
            <div id="mainBlogDiv" runat="server">
                <div id="noneDiv" runat="server" style="width:100%; text-align:center; margin-top:20px;" visible="false">
