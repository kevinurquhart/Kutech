<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="pricing.aspx.cs" Inherits="Kutech.Consultancy.pricing" %>
            ...
            <div class="row mt-6">
                ...
                <div class="col-12">
                    <div class="background-white px-3 mt-6 px-0 py-5 px-lg-5 radius-secondary">
                        ...
                        <p class="mt-3">With this in mind we value our services and time highly but understand that filling any gap in resource must be a financially prudent option. We believe we are competitively priced for our skillset and for such a short engagement.<br /><br />Note that Consultancy should ideally be a 1 to 2 day engagement.  If you are considering a longer engagement or project, please see our Support Services offering <a runat="server" href="~/Support/remoteDBA.aspx"><b>here</b></a>.</p>
                    </div>
                </div>
            </div>
            <!--/.row-->
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="generic_content clearfix">
                        ...
                        <div class="generic_price_btn clearfix">
                        	<a class="" runat="server" href="~/AddToCart.aspx?ProductID=7">Book Now</a>
                        </div>
                        <!--//BUTTON END-->
                ...
                <div class="col-md-4">
                    ...
                    <div class="generic_content active clearfix">
                        ...
                        <div class="generic_feature_list">
                        	<ul>
                            	<li><span>4 Hours Consultancy</span></li>
                                <li><span>Full Documentation</span></li>
                        ...
                        <!--BUTTON START-->
                        <div class="generic_price_btn clearfix">
                        	<a class="" runat="server" href="~/AddToCart.aspx?ProductID=9">Book Now</a>
                        </div>
                        <!--//BUTTON END-->
                ...
                <div class="col-md-4">
                    ...
                    <div class="generic_content clearfix">
                        ...
                        <div class="generic_feature_list">
                        	<ul>
                            	<li><span>7 Hours Consultancy</span></li>
                                <li><span>Full Documentation</span></li>
                                <li><span>All Tasks Undertaken</span></li>
                                <li><span>Actionable Results</span></li>
                            </ul>
                        ...
                        <!--BUTTON START-->
                        <div class="generic_price_btn clearfix">
                        	<a class="" runat="server" href="~/AddToCart.aspx?ProductID=8">Book Now</a>
                        </div>
                        <!--//BUTTON END-->
