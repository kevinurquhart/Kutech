...
namespace Kutech.Models
{
    public class ProductDatabaseInitializer : CreateDatabaseIfNotExists<ProductContext>
    {
        ...
        private static List<Product> GetProducts()
        {
            ...
            SqlDataReader myReader = myDAL.getProducts();
            ...
            while (myReader.Read())
            {
                ...
                p.Description = (string)myReader["Description"];
                p.ImagePath = (string)myReader["ImagePath"];
                p.UnitPrice = (double)myReader["UnitPrice"];
                p.CategoryID = (int)myReader["CategoryID"];
            }
