<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="privacy.aspx.cs" Inherits="Kutech.privacy" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="background-white">
        <div class="container" style="margin-bottom:-50px;">
            <div class="row mt-6">
                <div class="col">
                    <h3 class="text-center fs-2 fs-md-3" style="margin-top:-40px;">Our Privacy Policy</h3>
                    <hr class="short" data-zanim='{"from":{"opacity":0,"width":0},"to":{"opacity":1,"width":"4.20873rem"},"duration":0.8}' data-zanim-trigger="scroll" />
                </div>
                <div class="col-12" style="margin-top:-60px;">
                    <div class="background-white px-3 mt-6 px-0 py-5 px-lg-5 radius-secondary">
                        <p class="mt-3">This privacy policy applies between you, the User of this Website and Kutech Solutions Ltd, the owner and provider of this Website. Kutech Solutions Ltd takes the privacy of your information very seriously. This privacy policy applies to our use of any and all Data collected by us or provided by you in relation to your use of the Website.
                        <br />This privacy policy should be read alongside, and in addition to, our Terms and Conditions, which can be found at: <a href="terms.aspx">Kutech.co.uk/terms.aspx</a>
                        <br /><b>Please read this privacy policy carefully.</b></p>
                        <br />
                        ...
                        <p class="mt-3">
                            <ol>
                                <li>
                                    ...
                                    <b>Data</b> - <i>Collectively all information that you submit to Kutech Solutions Ltd via the Website. This definition incorporates, where applicable, the definitions provided in the Data Protection Laws;</i><br />
                                    <b>Data Protection Laws</b> - <i>Any applicable law relating to the processing of personal Data, including but not limited to the Directive 96/46/EC (Data Protection Directive) or the GDPR, and any national implementing laws, regulations and secondary legislation, for as long as the GDPR is effective in the UK;</i><br />
                                    <b>GDPR</b> - <i>The General Data Protection Regulation (EU) 2016/679;</i><br />
                        ...
                        <p class="mt-3">
                            <ol start="3">
                                <li>This privacy policy applies only to the actions of Kutech Solutions Ltd and Users with respect to this Website. It does not extend to any websites that can be accessed from this Website including, but not limited to, any links we may provide to social media websites.</li>
                                <li>For purposes of the applicable Data Protection Laws, Kutech Solutions Ltd is the "data controller". This means that Kutech Solutions Ltd determines the purposes for which, and the manner in which, your Data is processed.</li>
                            </ol>
                        </p>
                        <br />
                        <h5>Cookie Policy</h5>
                        ...
                        <p class="mt-3">
                            <ol start="13">
                                ...
                                <li>Technical and organisational measures include measures to deal with any suspected data breach. If you suspect any misuse or loss or unauthorised access to your Data, please let us know immediately by contacting us via this e-mail address: info@Kutech.co.uk.</li>
                        ...
                        <p class="mt-3">
                            <ol start="18">
                                ...
                                <li>To make enquiries, exercise any of your rights set out above, or withdraw your consent to the processing of your Data (where consent is our legal basis for processing your Data), please contact us via this e-mail address: info@Kutech.co.uk.</li>
