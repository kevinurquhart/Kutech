<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="terms.aspx.cs" Inherits="Kutech.terms" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <section>
        <div>
            <div class="background-holder overlay" style="background-image:url(assets/images/main/terms.jpg);background-position: center bottom;"> </div>
            <!--/.background-holder-->
            <div class="container">
                <div class="row pt-6">
                    <div class="col-md-8 px-md-0 color-white" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                        <div class="overflow-hidden">
                            <h1 class="color-white fs-4 fs-md-5 mb-0 zopacity" data-zanim='{"delay":0}'>Terms of Use</h1>
    ...
    <section class="background-white">
        <div class="container" style="margin-bottom:-50px;">
            <div class="row mt-6">
                <div class="col">
                    <h3 class="text-center fs-2 fs-md-3" style="margin-top:-40px;">Our Terms of Use</h3>
                    <hr class="short" data-zanim='{"from":{"opacity":0,"width":0},"to":{"opacity":1,"width":"4.20873rem"},"duration":0.8}' data-zanim-trigger="scroll" />
                </div>
                <div class="col-12" style="margin-top:-60px;">
                    <div class="background-white px-3 mt-6 px-0 py-5 px-lg-5 radius-secondary">
                        <h5>Introduction</h5>
                        <p class="mt-3">These terms and conditions apply between you, the User of this Website (including any sub-domains, unless expressly excluded by their own terms and conditions), and  Kutech Solutions Ltd,  the owner and operator of this Website. Please read these terms and conditions carefully, as they affect your legal rights. Your agreement to comply with and be bound by these terms and conditions is deemed to occur upon your first use of the Website. If you do not agree to be bound by these terms and conditions, you should stop using the Website immediately.
                        <br />In these terms and conditions, <b>User</b> or <b>Users</b> means any third party that accesses the Website and is not either (i) employed by  Kutech Solutions Ltd  and acting in the course of their employment or (ii) engaged as a consultant or otherwise providing services to  Kutech Solutions Ltd  and accessing the Website in connection with the provision of such services.
                        <br />You must be at least 18 years of age to use this Website. By using the Website and agreeing to these terms and conditions, you represent and warrant that you are at least 18 years of age.</p>
                        <br />
                        <h5>Intellectual property and acceptable use</h5>
                        <p class="mt-3">
                            <ol>
                                <li>All Content included on the Website, unless uploaded by Users, is the property of  Kutech Solutions Ltd,  our affiliates or other relevant third parties. In these terms and conditions, Content means any text, graphics, images, audio, video, software, data compilations, page layout, underlying code and software and any other form of information capable of being stored in a computer that appears on or forms part of this Website, including any such content uploaded by Users. By continuing to use the Website you acknowledge that such Content is protected by copyright, trademarks, database rights and other intellectual property rights. Nothing on this site shall be construed as granting, by implication, estoppel, or otherwise, any license or right to use any trademark, logo or service mark displayed on the site without the owner's prior written permission.</li>
                                <li>
                                    You may, for your own personal, non-commercial use only, do the following:<br />
                                    <ol type="a">
                                        <li>retrieve, display and view the Content on a computer screen</li>
                                        <li>print one copy of the Content</li>
                                    </ol>
                                </li>
                                <li>You must not otherwise reproduce, modify, copy, distribute or use for commercial purposes any Content without the written permission of  Kutech Solutions Ltd. </li>
                            </ol>
                        </p>
                        <br />
                        ...
                        <p class="mt-3">
                            <ol start="5">
                                <li>This Website may contain links to other sites. Unless expressly stated, these sites are not under the control of  Kutech Solutions Ltd  or that of our affiliates.</li>
                        ...
                        <p class="mt-3">
                            <ol start="8">
                                <li>Use of the Website is also governed by our Privacy Policy, which is incorporated into these terms and conditions by this reference. To view the Privacy Policy, please click on the following: <a href="privacy.aspx">Kutech.co.uk/privacy.aspx</a></li>
                            </ol>
                        </p>
                        <br />
                        ...
                        <p class="mt-3">
                            <ol start="9">
                                <li>Any online facilities, tools, services or information that  Kutech Solutions Ltd  makes available through the Website (the Service) is provided "as is" and on an "as available" basis. We give no warranty that the Service will be free of defects and/or faults. To the maximum extent permitted by the law, we provide no warranties (express or implied) of fitness for a particular purpose, accuracy of information, compatibility and satisfactory quality.  Kutech Solutions Ltd  is under no obligation to update information on the Website.</li>
                                <li>Whilst  Kutech Solutions Ltd  uses reasonable endeavours to ensure that the Website is secure and free of errors, viruses and other malware, we give no warranty or guaranty in that regard and all Users take responsibility for their own security, that of their personal details and their computers.</li>
                                <li>Kutech Solutions Ltd  accepts no liability for any disruption or non-availability of the Website.</li>
                                <li>Kutech Solutions Ltd  reserves the right to alter, suspend or discontinue any part (or the whole of) the Website including, but not limited to, any products and/or services available. These terms and conditions shall continue to apply to any modified version of the Website unless it is expressly stated otherwise.</li>
                            </ol>
                        </p>
                        <br />
                        ...
                        <p class="mt-3">
                            <ol start="13">
                                ...
                                <li>To the maximum extent permitted by law,  Kutech Solutions Ltd  accepts no liability for any of the following:</li>
                                <ol type="a">
                        ...
                        <br />
                        <h5>Kutech Solutions Ltd details</h5>
                        <p class="mt-3">
                            <ol start="23">
                                <li>Kutech Solutions Ltd is a company incorporated in England and Wales with registered number 13239896 whose registered address is Amelia House, Crescent Road, Worthing, West Sussex, BN11 1QR and it  operates the Website Kutech.co.uk.  The registered VAT number is 214542633. 
                                <br />You can contact Kutech Solutions Ltd by email on info@Kutech.co.uk.</li>
                            </ol>
                        </p>
                        <br />
                        <h5>Attribution</h5>
